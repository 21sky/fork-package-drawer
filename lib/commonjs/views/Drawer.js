...
class Drawer extends React.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "transitionTo", isOpen => {
      ...
      set(toValue, multiply(isOpen, this.drawerWidth, this.drawerPosition)), set(frameTime, 0), set(state.time, 0), set(state.finished, FALSE), set(state.velocity, this.velocityX), set(this.isOpen, isOpen), startClock(this.clock), set(this.manuallyTriggerSpring, FALSE)]), spring(this.clock, state, {
        ...SPRING_CONFIG,
        toValue
      }), cond(state.finished, [
    ...
    })), cond(eq(this.gestureState, _reactNativeGestureHandler.State.ACTIVE), [cond(this.isSwiping, NOOP, [
  ...
  render() {
    ...
    const offset = _reactNative.I18nManager.isRTL ? '100%' : multiply(this.drawerWidth, -1);
